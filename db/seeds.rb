...
# Create seed expense categories.
...
# Create seed income categories.
IncomeCategory::CATEGORIES.each do |category_name, subcategory_names|
  category = IncomeCategory.find_or_create_by(name: category_name, parent: nil)
  subcategory_names.each do |subcategory_name|
    IncomeCategory.find_or_create_by(name: subcategory_name, parent: category)
  end
end

puts 'Loaded IncomeCategory seeds'
